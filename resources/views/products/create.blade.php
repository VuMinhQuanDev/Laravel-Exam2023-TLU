            ...
            <form action = "{{ route('products.store') }}" method = "post">
              @csrf
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="product_id" name="product_id" placeholder="Nhập mã sản phẩm" >
                </div>
                <div class="form-group">
                ...
                <div class="form-group" >
                    ...
                    <input type="text" class="form-control" id="stock" name="stock" placeholder="Nhập doanh thu" >
                </div>
                <div class="form-group">
